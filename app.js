...
function loadPetsFromStorage() {
  const saved = localStorage.getItem("pet_searchers_portal_data_v11");
  if (saved) {
    try {
...
function savePetsToStorage() {
  localStorage.setItem("pet_searchers_portal_data_v11", JSON.stringify(petsData));
}
